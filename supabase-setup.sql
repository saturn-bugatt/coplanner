...
CREATE INDEX idx_scores_team_name ON scores(team_name);
...
CREATE INDEX idx_photos_team ON photos(team_name);
...
CREATE INDEX idx_commentary_created ON commentary(created_at DESC);
...
-- This creates it programmatically if you have permissions
...
CREATE POLICY "Allow public insert to photos bucket" ON storage.objects
  FOR INSERT WITH CHECK (bucket_id = 'photos');

-- =====================
-- DONE!
-- =====================
-- After running this SQL, test:
-- 1. Go to /photos and upload a photo
-- 2. Run analysis: npx tsx scripts/analyze.ts
